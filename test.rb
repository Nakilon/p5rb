...
describe :test do
  require "open3"
  def f expectation, (string, status)
  ...
  it "fen" do   # this example requires third-party gem
    f 42826, Bundler.with_unbundled_env{ Open3.capture2e "bundle exec ruby main.rb 'r3r2k/p1n2pb1/3p3p/1ppP1qN1/4N3/P3P3/1PQ2PP1/R4K1R w - - 0 1' > ../../temp.htm", chdir: "examples/fen" }
  end
  it "dot strip plot" do
    f 23174, Open3.capture2e("ruby examples/WO2022104460A1/main.rb > temp.htm")
  end
  it "scatter plot" do
    ...
    f 31053, Open3.capture2e("ruby examples/moscow/main.rb all.tsv > temp.htm")
  end
end
