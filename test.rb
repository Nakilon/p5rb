...
describe :test do
  ...
  it "fen" do   # this example requires third-party gem
      check 11, 0xff8900000000ffffff9181808000ffffffdfa04201fe0000ffd12000c0090000, base64(*Bundler.with_unbundled_env{ Open3.capture2e "bundle install >/dev/null && bundle exec ruby main.rb 'r3r2k/p1n2pb1/3p3p/1ppP1qN1/4N3/P3P3/1PQ2PP1/R4K1R w - - 0 1'", chdir: "examples/fen" })
  end
  ...
  it "scatter plot" do
    ...
    it "bar chart" do
      check 1, 0xfd7cf00080fec23d7ffee0408340c2fffe0000d040ff388167008b80408080ff, base64(*Open3.capture2e("ruby examples/tg_export/main.rb"))
    end
  end
